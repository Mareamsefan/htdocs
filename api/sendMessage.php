 ...
 * 1. Finn en måte å sende inn data på. Dette gjøres i denne filen (sendMessage.api)
 ...
 * 3. skriv om på emnePage.api til å inkludere en for loop(1) som henter alle messages (where subject_pin = subject_pin)
 ...
 * 5. lag sendReply. Gjør steg 1-2 om igjen i sendReply.api.
